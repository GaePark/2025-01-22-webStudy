...
public class MusicList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(startPage>1)
			out.println("<li><a href=\"MainServlet?mode=1&page="+(startPage-1)+"\">&lt;</a></li>");
		...
		for(int i=startPage;i<=endPage;i++) {
			...
			{
			out.println("<li><a href=\"MainServlet?mode=1&page="+i+"\">"+i+"</a></li>");
			}
		}

		if(endPage<totalpage)
			out.println("<li><a href=\"MainServlet?mode=1&page="+(endPage+1)+"\">&gt;</a></li>");
		...
		{
			if(p>8) break;
			out.println("<a href=MainServlet?mode=2&mno="+vo.getMno()+">");
