	...
	4. JavaScript : 브라우저에서 사용자 요청 처리 담당
		...
		브라우저    =================== 자바 ================ 오라클
			...
			=> 사용법
					...
					2) 외부 스크립트 : 파일을 제작해서 필요시마다 첨부
														 확장자(.js)
							<script type="text/javascript" src="파일명|URL"></script>
							=> import 
			...
			=> 버전 
				 ...
				 ES6 => let / const
				 				...
				 				function a(){}
				 				let a=function(){}
				 				***const a=()=> {} function과 return 제거
				 					 --------------
				 					 ㅣ함수안에서 처리가 가능
				자바스크립트 출력 : System.out.println()
				----------------- 브라우저에 출력
				1) alert() : 팝업창 출력
				2) console.log() => 도스창 출력
				3) document.write() => 브라우저에 출력
				4) innerHTML : 태그와 태그 사이
