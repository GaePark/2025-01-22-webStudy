            ...
            <form method=post action="../board/board_insert_ok.do">
            	<table class="table">
            		...
            		<tr>
            			...
            			<td width=85%>
            				<input type=text name=subject id=subject size=20 class="form-control-sm" required>
            			</td>
            		</tr>
            		<tr>
            		 ...
            		 <tr>
            			...
            			<td width=85%>
            				<input type=text name=pwd id=pwd size=20 class="form-control-sm" required>
            			</td>
            		</tr>
            		 <tr>
            			<td colspan="2" class="text-center">
            			<input type=submit value="글쓰기" class="btn-outline-primary btn-sm">
            			<input type=button value="취소" class="btn-outline-primary btn-sm" onclick="javascript:history.back()">
            			 </td>
            		</tr>
            	</table>
            	</form>
