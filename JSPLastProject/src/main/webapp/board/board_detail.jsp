        ...
        <div class="container">
            ...
            <table class="table">
            	...
            	<tr>
            		...
            		<td  class="text-center" width=20%>조회수</td>
            	...
            	<tr>
            		<td colspan=4 class="text-left" height="200" ><pre style="white-space:pre-wrap;border:none;background-color:white">${vo.content}</pre></td>
            	</tr>
            	<tr>
            	...
            	<tr id="delTr" style="display:none" data-no="${vo.no }" data-page="${page }">
            		...
            		비밀번호: <input type=password size=15 class="form-control-sm" id="pwd">
            							<input type=button value="삭제" style="display:none" class="btn-danger btn-sm" id="delBtn">
            		</td>
            	</tr>
            	<tr>
            		<td colspan="4" class="text-right">
