        ...
        <div class="container">
			...
			<table>
				...
				<c:if test="${sessionScope.id!=null}">
					...
					<a href="#" class="btn btn-sm btn-danger">에약하기</a>
					</c:if>
					<a href="../food/list.do?page=${page }" class="btn btn-sm btn-primary">목록</a>
				</td>
				</tr>
			</table>
                                ...
                                <div class="related-post-slider owl-carousel">
                                    ...
                                    <div class="single-post">
                                        ...
                                        <div class="post-thumb">
                                            <img src="https://www.menupan.com${image }" alt="">
                                        </div>
                                    </div>
                                    </c:forTokens>
                                    <!-- Single Related Post-->
